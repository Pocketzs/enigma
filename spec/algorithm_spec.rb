...
describe Algorithm do
  describe '#initialize' do
    ...
    it 'has attributes' do
      ...
      expect(a.message).to eq 'keder ohulw'
      expect(a.key).to eq '02715'
      expect(a.date).to eq '040895'
      expect(a2.message).to eq'pysgdmxtlssglgxe'
      expect(a2.key).to eq '91034'
      expect(a2.date).to eq '131122'
    end
  end
  ...
  describe 'decrypt/encrypt_message helper methods' do
    describe '#message_chars' do
      it 'returns an array of the messages characters downcased' do
        ...
        expect(a.message_chars).to eq ['k', 'e', 'd', 'e', 'r', ' ', 'o', 'h', 'u', 'l', 'w', '!']
      end
    end
    ...
    describe '#message_index' do
      it 'returns an array of the message characters index based on character set' do
        ...
        expect(a.message_index).to eq [10, 4, 3, 4, 17, 26, 14, 7, 20, 11, 22, "!"]
      end
    end
    ...
    describe '#shift_cycle' do
      it 'loops the shift in a cycle' do
        ...
        result = a.shift_cycle.first(6)

        expect(a.shift_cycle).to be_a Enumerator
